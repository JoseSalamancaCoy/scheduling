Feature: Sistema de Agendamiento de Citas con Empleados
  ...
  Scenario Outline: Calcular fecha de notificación cuando hoy es día hábil del empleado
    ...
    Examples:
      ...
      | 2024-03-04   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 09:00          | 18:00       | no trabaja       | []            | 2024-03-04         | 2024-03-05          | 2024-03-12 | 09:00           | 17:00         |
      | 2024-03-05   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 10:00          | 19:00       | trabaja          | []            | 2024-03-05         | 2024-03-06          | 2024-03-13 | 10:00           | 17:00         |
  ...
  Scenario Outline: Calcular fecha de notificación cuando hoy es día no hábil del empleado
    ...
    Examples:
      ...
      | 2024-03-03   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 09:00          | 18:00       | no trabaja       | []            | 2024-03-04         | 2024-03-05          | 2024-03-12 |
      | 2024-03-07   | ["lunes", "martes", "miércoles", "jueves", "sábado"]        | 10:00          | 16:00       | trabaja          | []            | 2024-03-07         | 2024-03-09          | 2024-03-18 |
  ...
  Scenario Outline: Manejo de días festivos
    ...
    Examples:
      | fecha_actual | dias_trabajo_empleado                                        | horario_inicio | horario_fin | trabaja_festivos | dias_feriados           | fecha_notificacion | fecha_inicio_conteo | fecha_cita |
      | 2024-12-25   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 09:00          | 18:00       | trabaja          | ["2024-12-25"]         | 2024-12-25         | 2024-12-26          | 2025-01-02 |
      | 2024-12-25   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 09:00          | 18:00       | no trabaja       | ["2024-12-25"]         | 2024-12-26         | 2024-12-27          | 2025-01-03 |
      | 2024-01-01   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 10:00          | 17:00       | no trabaja       | ["2024-01-01"]         | 2024-01-02         | 2024-01-03          | 2024-01-10 |
  ...
  Scenario Outline: Validación de compatibilidad horaria empleado-abogado
    ...
    Examples:
      ...
      | 2024-03-04   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 09:00          | 18:00       | no trabaja       | []            | debe existir traslape horario de "09:00" a "17:00"                       |
      | 2024-03-04   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 18:00          | 22:00       | no trabaja       | []            | no debe existir traslape horario                                          |
      | 2024-03-04   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 06:00          | 10:00       | no trabaja       | []            | debe existir traslape horario de "08:00" a "10:00"                       |
      | 2024-03-04   | ["sábado", "domingo", "lunes", "martes", "miércoles"]       | 09:00          | 18:00       | trabaja          | []            | debe existir traslape horario de "09:00" a "17:00"                       |
  ...
  Scenario Outline: Casos extremos - Múltiples festivos consecutivos
    ...
    Examples:
      | fecha_actual | dias_trabajo_empleado                                        | horario_inicio | horario_fin | trabaja_festivos | dias_feriados                                    | fecha_notificacion | fecha_inicio_conteo | fecha_cita |
      | 2024-12-23   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 09:00          | 18:00       | no trabaja       | ["2024-12-25", "2024-12-26", "2025-01-01"]     | 2024-12-23         | 2024-12-24          | 2025-01-03 |
      | 2024-12-24   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 09:00          | 18:00       | no trabaja       | ["2024-12-25", "2024-12-26", "2025-01-01"]     | 2024-12-24         | 2024-12-27          | 2025-01-06 |
  ...
  Scenario Outline: Casos extremos - Empleado sin días comunes con abogado
    ...
    Examples:
      ...
      | 2024-03-02   | ["sábado", "domingo", "sábado", "domingo", "sábado"]         | 09:00          | 18:00       | no trabaja       | []            |
      | 2024-03-09   | ["domingo", "sábado", "domingo", "sábado", "domingo"]        | 10:00          | 16:00       | trabaja          | []            |
  ...
  Scenario Outline: Casos extremos - Sin traslape horario
    ...
    Examples:
      | fecha_actual | dias_trabajo_empleado                                        | horario_inicio | horario_fin | trabaja_festivos | dias_feriados |
      | 2024-03-04   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 18:00          | 22:00       | no trabaja       | []            |
      | 2024-03-04   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 05:00          | 07:00       | trabaja          | []            |
  ...
  Scenario Outline: Validación de estructura de respuesta de la API
    ...
    Examples:
      | fecha_actual | dias_trabajo_empleado                                        | horario_inicio | horario_fin | trabaja_festivos | dias_feriados |
      | 2024-03-04   | ["lunes", "martes", "miércoles", "jueves", "viernes"]       | 09:00          | 18:00       | no trabaja       | []            |